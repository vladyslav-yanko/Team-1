...
function onMousemoveCardHandler(evt) {
  var cardInner = this.querySelector(".card__inner");
  var halfHeight = cardInner.offsetHeight / 2;
  var halfWidth = cardInner.offsetWidth / 2;
  var y = evt.offsetY;
  var x = evt.offsetX;
  cardInner.style.transform = "rotateX(".concat((-y + halfHeight) / 5, "deg) rotateY(").concat((x - halfWidth) / 4, "deg)");
}

function onMouseleaveCardHandler(evt) {
  var cardItem = this.querySelector(".card__inner");
